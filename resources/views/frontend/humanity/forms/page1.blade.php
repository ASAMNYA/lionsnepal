...
<head>
  ...
  <title></title>
     ...
     <link rel="stylesheet" type="text/css" href="{{url('public/css/frontend/css/mystyle.css')}}">
     <style type="text/css">
       .save_button {
    min-width: 100px;
    max-width: 100px;
       ...
       <div class="col-sm-9" style="border: 4px solid grey;border-radius: 11px;">
        <div class="container">
          <div class="row">
           <div class="col-sm-7">
            <center>
         <h2 style="border: 2px inset;background-color: #f1f1f1;
    /* text-shadow: -6px 0px 5px rgba(150, 150, 21, 0.75); */
    border-radius: 5px; padding: 10px;">The international Association of Lions club 32532 Nepal</h2>
         <hr>
          </center>
          </div><!-- end of col-sm-2 -->
          ...
          <div class="col-sm-2">
            ...
            <center>
          <img align="center" src="images.png" style=" margin: 19px 30px 0 0;
    border: 3px inset;
    border-radius: 7px;
    height: 104px;
    width: 114px;">
        ...
        <div class="container">
          <div class="row">
           ...
           <div class="col-sm-2">
              <img src="images.png" align="center" style="margin: 3px 30px 0 72px;
    border: 3px inset;
    border-radius: 7px;
    height: 104px;
    width: 114px;">
