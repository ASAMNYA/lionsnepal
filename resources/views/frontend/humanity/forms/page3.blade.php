       ...
       <div class="col-sm-9" style="border: 4px solid grey;border-radius: 11px;">
        <div class="container">
         ...
         <hr>
            ...
            <center>
          <img align="right" src="images.png" style=" margin: 19px 36px 0 0;
    border: 3px inset;
    border-radius: 7px;
    height: 104px;
    width: 114px;">
    ...
    border-radius: 11px;">
          ...
          <h2><center style="border: 2px inset;border-radius: 5px;background-color: #f1f1f1;padding: 10px;">Member Info</center></h2>
            ...
            <div class="form-group">
             ...
             <label> Address: </label><input type="text" class="form-control" name="" placeholder=" Address" class="form-control">
             &nbsp;&nbsp;
             <label>Sex: </label>
             <select name="">
              <option value="0"> Male</option>
             ...
             &nbsp;&nbsp;
             <span> DOB: </span><input type="Date" class="form-control" name="" placeholder="Date">
           </br></br></br>
            ...
            <span>Permanent Address : </span><input type="text" name="" placeholder="State"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" name="" placeholder="Municipality"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="text" name="" placeholder="Ward"> 
