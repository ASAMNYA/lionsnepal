...
@if(isset ($model))    
{{ Form::model($model, ['route' => ['admin.pnlf.update', $model], 'class' => 'form-horizontal', 'files'=> 'true', 'role' => 'form', 'method' => 'PATCH']) }}
@else
{{ Form::open(['route' => 'admin.pnlf.store', 'class' => 'form-horizontal', 'files'=> 'true', 'role' => 'form', 'method' => 'post']) }}
@endif
 ...
 <div class="form-group">
    ...
    <div class="box box-info">
        <div class="box-body">
            <div class="pull-left">
                {{ link_to_route('admin.pnlf', trans('cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
            </div><!--pull-left-->
...
<div class="col-md-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title">
                <a href="{!! url('admin/pnlf') !!}" class="btn btn-primary">add</a>
              pnlf
                </h3>
                    ...
                    <table id="users-table" class="table table-condensed table-hover">
                        ...
                        @foreach($data as $field)
                            <tr>
                                ...
                                <td class="col-md-1"> 
                                {!! link_to_route('admin.pnlf.edit', '', array($field->id),
                                              array('class' => 'fa fa-pencil-square-o fa-fw')) !!}
                                    
                                </td>
                                 <td class="col-md-1"> 
                                  {!! link_to_route('admin.pnlf.delete', '', array($field->id),
