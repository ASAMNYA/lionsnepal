...
@endif
  ...
  <div class="box box-primary">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-10">
                    {{ Form::text('title', NULL, ['class' => 'form-control', 'placeholder' =>'Enter Name of Organization']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
            ...
            <div class="form-group">
                {{ Form::label('Motto','Motto', ['class' => 'col-lg-2 control-label']) }}

                <div class="col-lg-10">
                    {{ Form::text('message', NULL, ['class' => 'form-control', 'placeholder' =>'Enter the message/motto']) }}
                </div><!--col-lg-10-->
            </div><!--form control-->
            ...
            <div class="form-group">
                {{ Form::label('phone_no','Phone No', ['class' => 'col-lg-2 control-label']) }}
    ...
    <div class="box box-info">
        <div class="box-body">
            <div class="pull-left">
                {{ link_to_route('admin.contact', trans('cancel'), [], ['class' => 'btn btn-danger btn-xs']) }}
            </div><!--pull-left-->
