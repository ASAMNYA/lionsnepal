    ...
    Route::group(['namespace' => 'Auth' , 'as' => 'auth.'] , function () {
        ...
        Route::group(['middleware' => 'guest'] , function () {
            ...
            if (config('access.users.registration')) {
                ...
                Route::get('register/employer' , 'RegisterController@showRegistrationFormEmployer')->name('registerEmployer');
                Route::post('register/employerPost' , 'RegisterController@registerEmployer')->name('registerEmployer.post');
