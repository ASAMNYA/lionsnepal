...
class UserRepository extends BaseRepository
{
     ...
     */
    public function __construct(RoleRepository $role , ParentModel $parent , Teacher $teacher, Student $student)
    {
        $this->role = $role;
        $this->parent = $parent;
    ...
    public function create($input)
    {
        ...
        DB::transaction(function () use ($user, $data, $roles) {
            if ($user->save()) {
                ...
                if(array_key_exists(2, $roles['assignees_roles'])){
                    $this->parent->create([
                ...
                elseif(array_key_exists(3, $roles['assignees_roles'])){
                    $this->teacher->create([
                ...
                elseif(array_key_exists(4, $roles['assignees_roles'])){
                    $this->student->create([
