<?php
    ...
    class RoleRepository extends BaseRepository
    {
        ...
        public function getDefaultUserRoleForEmployer()
        {

            if (is_numeric(config('access.users.employer_role'))) {
                return $this->query()->where('id' , (int)config('access.users.employer_role'))->first();
            }

            return $this->query()->where('name' , config('access.users.employer_role'))->first();
        }
    }
