...
use App\Models\Globals\SeekerProfile;
use App\Models\Globals\Company;
...
class UserRepository extends BaseRepository
{
     ...
     */
    public function __construct(RoleRepository $role, SeekerProfile $profile, Company $company)
    {
    ...
    public function createEmployer(array $data, $provider = false)
    {
        ...
        DB::transaction(function () use ($user) {
            ...
            if ($user->save()) {
                 ...
                 * Add the default site role to the new user
                 */
                $user->attachRole($this->role->getDefaultUserRoleForEmployer());
              
                    $d=$this->company->create([
